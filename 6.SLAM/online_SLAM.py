    ...
    for k in range(len(data)):
        ...
        for i in range(len(measurement)):
            ...
            for b in range(2):
                ...
                Xi.value[m + b][0] += measurement[i][1 + b] / measurement_noise
        expansion_index = [0, 1] + list(range(4, dim + 2))
        Omega = Omega.expand(dim + 2, dim + 2, expansion_index, expansion_index)
        Xi = Xi.expand(dim + 2, dim + 2, expansion_index, [0])
        for b in range(4):
