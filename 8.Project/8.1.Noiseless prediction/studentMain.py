...
def estimate_next_pos(measurement, OTHER = None):
    ...
    if OTHER is None:
        ...
        OTHER = {"previous_measurement": measurement, "previous_heading": None}
    else:
        ...
        if OTHER["previous_heading"] is None:
            ...
            turning_est = heading_est - OTHER["previous_heading"]
            next_heading = angle_trunc(heading_est + turning_est)
            x_est += distance_est * cos(next_heading)
            y_est += distance_est * sin(next_heading)
